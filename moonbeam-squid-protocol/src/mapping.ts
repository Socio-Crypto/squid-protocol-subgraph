...
export function handleNativeGasPaidForContractCallWithToken(event: NativeGasPaidForContractCallWithToken): void {
  ...
  if(!addressStat) {
    ...
    addressStat.sourceChain = "Moonbeam";
  ...
  if(!tokenStat) {
    ...
    tokenStat.sourceChain = "Moonbeam";
  ...
  if(!addressStatByDate) {
    ...
    addressStatByDate.sourceChain = "Moonbeam";
  ...
  if(!tokenStatsByDate) {
    ...
    tokenStatsByDate.sourceChain = "Moonbeam";
...
// start tokenStatsByMonth entity 
  ...
  if(!tokenStatsByMonth) {
    ...
    tokenStatsByMonth.sourceChain = "Moonbeam";
  ...
  let sourceChainId = 'Moonbeam' + "_" + event.params.symbol
