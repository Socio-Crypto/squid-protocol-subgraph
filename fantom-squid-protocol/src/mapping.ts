...
export function handleNativeGasPaidForContractCallWithToken(event: NativeGasPaidForContractCallWithToken): void {
  ...
  if(!addressStat) {
    ...
    addressStat.sourceChain = "Fantom";
  ...
  if(!addressStatByDate) {
    ...
    addressStatByDate.sourceChain = "Fantom";
  ...
  if(!tokenStatsByDate) {
    ...
    tokenStatsByDate.sourceChain = "Fantom";
...
// start tokenStatsByMonth entity 
  ...
  if(!tokenStatsByMonth) {
    ...
    tokenStatsByMonth.sourceChain = "Fantom";
  ...
  let sourceChainId = 'Fantom' + "_" + event.params.symbol
